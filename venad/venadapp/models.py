...
class Employee(models.Model):
    ...
    employee_id = models.CharField(max_length=50, null=True)  # Assuming it's unique
    name = models.CharField(max_length=255)
    ...
    ac_number = models.CharField(max_length=255)  # Account Number
    govt_id = models.ImageField(upload_to='photos/', null=True, blank=True)
...
class Adv_payment(models.Model):
    employee = models.ForeignKey(Employee, on_delete=models.CASCADE,null=True)
    date = models.DateField(null=True)
    amount = models.CharField(max_length=50, null=True)
    remainingbalence = models.CharField(max_length=50, null=True)
